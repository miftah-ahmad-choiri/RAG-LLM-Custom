...
> **Index:** `23.9.4`  
> **Source:** [https://www.ibm.com/docs/en/storage-ceph/9.9.1?topic=gateways-using-load-balancing-scale-up-scale-down](https://www.ibm.com/docs/en/storage-ceph/9.9.1?topic=gateways-using-load-balancing-scale-up-scale-down)
...
> 📝 **Note:** Note:
If automatic listeners were enabled either during subsystem creation or by using the
`subsystem add_network`
command, listeners do not need to be added during scale-up operations. Skip to step
2
.
