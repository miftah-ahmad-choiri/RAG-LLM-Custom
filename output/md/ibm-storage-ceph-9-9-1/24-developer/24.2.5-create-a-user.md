...
> **Index:** `24.2.5`  
> **Source:** [https://www.ibm.com/docs/en/storage-ceph/9.9.1?topic=api-create-user](https://www.ibm.com/docs/en/storage-ceph/9.9.1?topic=api-create-user)
...
Specify the default placement target for the user.
...
Specify the default storage class for the user.
...
```plaintext-ibm
$ curl --ipv4 --http1.1 --aws-sigv4 aws:amz:us-east-1:s3 \
-u 'ACCESS_KEY:SECRET_KEY' \
-H x-amz-content-sha256:UNSIGNED-PAYLOAD \
-X PUT \
"http://HOSTNAME/admin/user?default-placement=default-placement&default-storage-class=cold&display-name=test4&uid=curl4"
```
