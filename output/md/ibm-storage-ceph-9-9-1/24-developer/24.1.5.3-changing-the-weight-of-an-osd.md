...
> **Index:** `24.1.5.3`  
> **Source:** [https://www.ibm.com/docs/en/storage-ceph/9.9.1?topic=configurations-changing-weight-osd](https://www.ibm.com/docs/en/storage-ceph/9.9.1?topic=configurations-changing-weight-osd)
...
$ python
>> import requests
>> result = requests.patch('https://CEPH_MANAGER:8080/api/osd/ID', json={"reweight": VALUE}, auth=("USER", "PASSWORD"))
>> print(result.json())
```
