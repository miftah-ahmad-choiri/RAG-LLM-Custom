...
> **Index:** `18.2.1`  
> **Source:** [https://www.ibm.com/docs/en/storage-ceph/9.9.1?topic=deployment-deploying-ceph-object-gateway-using-command-line-interface](https://www.ibm.com/docs/en/storage-ceph/9.9.1?topic=deployment-deploying-ceph-object-gateway-using-command-line-interface)
